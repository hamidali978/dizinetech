...
const Home3Testimonial = () => {
    ...
    return (
        <>
            <div className="home3-testimonial-section">
                <div className="container">
                    <div className="row justify-content-center mb-70">
                        <div className="col-lg-7 text-animation">
                            <div className="section-title text-center">
                                <span className="sub-title">Client Testimonial</span>
                                <h2>Happy Clients, Happy Feeds.</h2>
                    ...
                    <div className="home3-testimonial-slider-wrap">
                        <div className="row">
                    ...
                    <div className="testimonial-btm-area">
