...
const Home3Footer = () => {
    return (
        <>
            <footer className="footer-section2 style-2">
                    ...
                    <div className="container">
                        <div className="footer-menu-wrap">
                            <div className="row gy-5">
                                    ...
                                    <div className="logo-and-rating-area">
                                        <div className="footer-logo">
                                            <Link href="/social-marketing">
                                                <img src="assets/img/footer-logo2-white.svg" alt="" />
                                            </Link>
                                        </div>
                                        ...
                                        <ul className="rating-area">
                                            ...
                                            <li>
                                                <a href="https://www.google.com/" className="single-rating google">
                                                    <div className="review">
                                                        <span>Review On</span>
                                                        <img src="assets/img/home3/icon/google-logo-white.svg" alt="" />
                                                    </div>
                                                    <div className="rating">
                                                        <ul className="star">
                                                            <li><i className="bi bi-star-fill" /></li>
                                ...
                                <div className="col-lg-2 col-sm-6 d-flex justify-content-lg-center justify-content-sm-center">
                                ...
                                <div className="col-lg-2 col-sm-5 d-flex justify-content-xl-end justify-content-lg-center">
                                    <div className="footer-widget">
                                        <div className="widget-title">
                                            <h4>Who we are</h4>
                                        </div>
                                ...
                                <div className="col-lg-4 col-sm-7 d-flex justify-content-sm-end">
