...
const ServiceDetailsPageSection = () => {
    return (
        <>
            <div className="service-details-page pt-150 mb-120" id="scroll-section">
                                ...
                                <div className="row g-4">
                                    <div className="col-lg-12 order-lg-1 order-2">
                                        <div className="service-details-img">
                                            <img src="assets/img/inner-pages/service-details-img.jpg" alt="" />
                                        </div>
                                    </div>
                            ...
                            <div className="service-details-content-wrap">
                                ...
                                <div className="img-grp">
                                    <div className="row g-xxl-4 g-xl-3 g-2">
                                        ...
                                        <div className="col-sm-6">
                                            <img src="assets/img/inner-pages/service-details-img3.jpg" alt="" />
                                        </div>
                                    </div>
                                </div>
...
export default ServiceDetailsPageSection