...
const Home6Faq = () => {
    return (
        <>
                                    ...
                                    <div className="accordion-item">
                                        ...
                                        <div id="faqcollapseOne" className="accordion-collapse collapse show" aria-labelledby="faqheadingOne" data-bs-parent="#accordionGeneral">
                                            <div className="accordion-body">
                                                Social marketing is a strategy that uses marketing principles to influence behaviors that benefit individuals and communities for the greater social good.
                                            </div>
                                        </div>
                                    </div>
                                    <div className="accordion-item">
            ...
            <div className="home6-tools-section mb-120">
                <div className="container">
                    <div className="row g-4 justify-content-between align-items-lg-end mb-60">
                        <div className="col-xl-6 col-lg-7">
                            <div className="section-title five text-animation">
                                <span className="sub-title">Integrate Plugin</span>
                                <h2>Integrate With Your Favorite Tools</h2>
                            </div>
                        </div>
                        <div className="col-lg-4 d-flex justify-content-lg-end text-animation">
                            <a href="#" className="primary-btn3" data-text="Discover More">
                    ...
                    <div className="row g-4">
                        <div className="col-lg-4 col-sm-6">
                            <div className="tools-card magnetic-item">
                                <div className="icon">
                                    <img src="assets/img/home6/icon/ninja-seo-logo.svg" alt="" />
                                </div>
                        ...
                        <div className="col-lg-4 col-sm-6">
                            <div className="tools-card magnetic-item">
                                <div className="icon">
                                    <img src="assets/img/home6/icon/hubspot-logo.svg" alt="" />
                                </div>
                                <div className="content">
                                    <h6>HubSpot</h6>
                                    <p>On the other hand denounce with right eou info and dislike beguled.</p>
                        ...
                        <div className="col-lg-4 col-sm-6">
                            <div className="tools-card magnetic-item">
                                <div className="icon">
                                    <img src="assets/img/home6/icon/shopify-logo.svg" alt="" />
                                </div>
                                <div className="content">
                                    <h6>Shopify</h6>
                                    <p>On the other hand denounce with right eou info and dislike beguled.</p>
                        ...
                        <div className="col-lg-4 col-sm-6">
                            <div className="tools-card magnetic-item">
                                <div className="icon">
                                    <img src="assets/img/home6/icon/semrush-logo.svg" alt="" />
                                </div>
                                <div className="content">
                                    <h6>Semrush</h6>
                                    <p>On the other hand denounce with right eou info and dislike beguled.</p>
                        ...
                        <div className="col-lg-4 col-sm-6">
                            <div className="tools-card magnetic-item">
                                <div className="icon">
                                    <img src="assets/img/home6/icon/mailchimp-icon.svg" alt="" />
                                </div>
                                <div className="content">
                                    <h6>Mailchimp</h6>
                                    <p>On the other hand denounce with right eou info and dislike beguled.</p>
                        ...
                        <div className="col-lg-4 col-sm-6">
                            <div className="tools-card magnetic-item">
                                <div className="icon">
                                    <img src="assets/img/home6/icon/topvisor-logo.svg" alt="" />
                                </div>
                                <div className="content">
                                    <h6>Topvisor</h6>
                                    <p>On the other hand denounce with right eou info and dislike beguled.</p>
                        ...
                        <div className="col-lg-4 col-sm-6">
                            <div className="tools-card magnetic-item">
                                <div className="icon">
                                    <img src="assets/img/home6/icon/serpple-logo.svg" alt="" />
                                </div>
                                <div className="content">
                                    <h6>Serpple</h6>
                                    <p>On the other hand denounce with right eou info and dislike beguled.</p>
                        ...
                        <div className="col-lg-4 col-sm-6">
                            <div className="tools-card magnetic-item">
                                <div className="icon">
                                    <img src="assets/img/home6/icon/open-aI-logo.svg" alt="" />
                                </div>
                                <div className="content">
                                    <h6>Open AI</h6>
                                    <p>On the other hand denounce with right eou info and dislike beguled.</p>
                        ...
                        <div className="col-lg-4 col-sm-6">
                            <div className="tools-card magnetic-item">
                                <div className="icon">
                                    <img src="assets/img/home6/icon/name-cheap-logo.svg" alt="" />
                                </div>
                                <div className="content">
                                    <h6>Name Cheap</h6>
                                    <p>On the other hand denounce with right eou info and dislike beguled.</p>
