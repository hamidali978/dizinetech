...
const FaqPage = () => {
    return (
        <>
            ...
            <Breadcrum pageTitle={"FAQ"} pagename={"FAQ"} />
            <div className="faq-page pt-150 mb-120" id="scroll-section">
                <div className="container">
                    <div className="row justify-content-center mb-60">
                        <div className="col-xl-7 col-lg-8 text-animation">
                            <div className="section-title five text-center">
                                <span className="sub-title">FAQ Update</span>
                                <h2>We Get Answers To Your Common Queries.</h2>
                            </div>
                        </div>
                    </div>
                    <div className="row gy-5">
                            ...
                            <div className="faq-contact-wrap">
                                <div className="faq-nav-btn-area">
                                    <div className="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                        ...
                                        <button className="nav-link" id="strategy-tab" data-bs-toggle="pill" data-bs-target="#strategy" type="button" role="tab" aria-controls="strategy" aria-selected="false">Strategy &amp; Planning</button>
                                        <button className="nav-link" id="budget-tab" data-bs-toggle="pill" data-bs-target="#budget" type="button" role="tab" aria-controls="budget" aria-selected="false">Budget &amp; Pricing</button>
                                        <button className="nav-link" id="traning-tab" data-bs-toggle="pill" data-bs-target="#traning" type="button" role="tab" aria-controls="traning" aria-selected="false">Training &amp; Support</button>
                                    </div>
                                </div>
                        ...
                        <div className="col-lg-9">
                            <div className="tab-content" id="v-pills-tabContent">
                                            ...
                                            <div className="accordion-item mb-10">
                                                <h2 className="accordion-header" id="faqheadingOne">
                                                    <button className="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#faqcollapseOne" aria-expanded="true" aria-controls="faqcollapseOne">
                                                        01. What is Social Marketing And How Does It Work?
                                                ...
                                                <div id="faqcollapseOne" className="accordion-collapse collapse show" aria-labelledby="faqheadingOne" data-bs-parent="#accordionGeneral">
                                                    <div className="accordion-body">
                                                        Social marketing is a strategy that uses marketing principles and techniques to influence behaviors that benefit individuals and society as a whole. It works by identifying a social issue, understanding the target audience's needs and motivations, and crafting messages or campaigns that encourage positive behavior changes.
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="accordion-item mb-10">
                                                <h2 className="accordion-header" id="faqheadingTwo">
                                                    <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqcollapseTwo" aria-expanded="false" aria-controls="faqcollapseTwo">
                                                        02. Is Nexaq Suitable For My Business?
                                                        <svg width={14} height={14} viewBox="0 0 14 14" xmlns="http://www.w3.org/2000/svg">
                                                            <path fillRule="evenodd" clipRule="evenodd" d="M7.89753 13.1434C7.89753 10.5799 10.1789 8.24351 12.6862 8.24351L13.7139 8.24351L13.7139 6.14057L12.6862 6.14057C10.8632 6.14057 9.15329 6.95861 7.89753 8.24246L7.89754 -2.63656e-07L5.84229 -3.56821e-07L5.84229 8.24246C4.58654 6.95861 2.87658 6.14057 1.05358 6.14057L0.0259626 6.14057L0.0259625 8.24351L1.05358 8.24351C3.55995 8.24351 5.84229 10.5799 5.84229 13.1434L5.84229 14.1948L7.89753 14.1948L7.89753 13.1434Z" />
                                                        </svg>
                                                    </button>
                                                ...
                                                <div id="faqcollapseTwo" className="accordion-collapse collapse" aria-labelledby="faqheadingTwo" data-bs-parent="#accordionGeneral">
                                                    <div className="accordion-body">
                                                        Nexaq is designed to support a variety of businesses whether you are a small startup or a large enterprise, Nexaq can help streamline your operations, and enhance productivity.
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="accordion-item mb-10">
                                                <h2 className="accordion-header" id="faqheadingThree">
                                                    <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqcollapseThree" aria-expanded="false" aria-controls="faqcollapseThree">
                                                        03. The System Requirements Using Social Marketing?
                                                        <svg width={14} height={14} viewBox="0 0 14 14" xmlns="http://www.w3.org/2000/svg">
                                                            <path fillRule="evenodd" clipRule="evenodd" d="M7.89753 13.1434C7.89753 10.5799 10.1789 8.24351 12.6862 8.24351L13.7139 8.24351L13.7139 6.14057L12.6862 6.14057C10.8632 6.14057 9.15329 6.95861 7.89753 8.24246L7.89754 -2.63656e-07L5.84229 -3.56821e-07L5.84229 8.24246C4.58654 6.95861 2.87658 6.14057 1.05358 6.14057L0.0259626 6.14057L0.0259625 8.24351L1.05358 8.24351C3.55995 8.24351 5.84229 10.5799 5.84229 13.1434L5.84229 14.1948L7.89753 14.1948L7.89753 13.1434Z" />
                                                        </svg>
                                                    </button>
                                                ...
                                                <div id="faqcollapseThree" className="accordion-collapse collapse" aria-labelledby="faqheadingThree" data-bs-parent="#accordionGeneral">
                                                    <div className="accordion-body">
                                                        The system requirements for using social marketing typically include a stable internet connection, access to social media platforms.
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="accordion-item mb-10">
                                                ...
                                                <div id="faqcollapseFour" className="accordion-collapse collapse" aria-labelledby="faqheadingFour" data-bs-parent="#accordionGeneral">
                                                    <div className="accordion-body">
                                                        To upgrade your subscription, log in to your account, navigate to the subscription section, and select the upgrade option.
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="accordion-item mb-10">
                                                ...
                                                <div id="faqcollapseFive" className="accordion-collapse collapse" aria-labelledby="faqheadingFive" data-bs-parent="#accordionGeneral">
                                                    <div className="accordion-body">
                                                        To protect user privacy, we implement various measures including data encryption, secure authentication processes, regular security audits, and strict access controls.
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="accordion-item mb-10">
                                                ...
                                                <div id="faqcollapseSix" className="accordion-collapse collapse" aria-labelledby="faqheadingSix" data-bs-parent="#accordionGeneral">
                                                    <div className="accordion-body">
                                                        If you're encountering technical issues, start by refreshing the page or clearing your browser's cache and cookies. Ensure your browser is up to date, and check your internet connection.
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="accordion-item mb-10">
                                                <h2 className="accordion-header" id="faqheadingSeven">
                                                    <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqcollapseSeven" aria-expanded="false" aria-controls="faqcollapseSeven">
                                                        07. What Is Content Marketing And How Does It Work?
                                                        <svg width={14} height={14} viewBox="0 0 14 14" xmlns="http://www.w3.org/2000/svg">
                                                            <path fillRule="evenodd" clipRule="evenodd" d="M7.89753 13.1434C7.89753 10.5799 10.1789 8.24351 12.6862 8.24351L13.7139 8.24351L13.7139 6.14057L12.6862 6.14057C10.8632 6.14057 9.15329 6.95861 7.89753 8.24246L7.89754 -2.63656e-07L5.84229 -3.56821e-07L5.84229 8.24246C4.58654 6.95861 2.87658 6.14057 1.05358 6.14057L0.0259626 6.14057L0.0259625 8.24351L1.05358 8.24351C3.55995 8.24351 5.84229 10.5799 5.84229 13.1434L5.84229 14.1948L7.89753 14.1948L7.89753 13.1434Z" />
                                                        </svg>
                                                    </button>
                                                ...
                                                <div id="faqcollapseSeven" className="accordion-collapse collapse" aria-labelledby="faqheadingSeven" data-bs-parent="#accordionGeneral">
                                                    <div className="accordion-body">
                                                        Content marketing is a strategic approach that involves creating and sharing valuable, relevant content to attract and engage a target audience. It works by addressing the audience's needs and interests through various forms of content, such as blogs, videos, or social media posts.
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="accordion-item mb-10">
                                                <h2 className="accordion-header" id="faqheadingEight">
                                                    <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqcollapseEight" aria-expanded="false" aria-controls="faqcollapseEight">
                                                        08. How Can Social Media Marketing Help My Business?
                                                        <svg width={14} height={14} viewBox="0 0 14 14" xmlns="http://www.w3.org/2000/svg">
                                                            <path fillRule="evenodd" clipRule="evenodd" d="M7.89753 13.1434C7.89753 10.5799 10.1789 8.24351 12.6862 8.24351L13.7139 8.24351L13.7139 6.14057L12.6862 6.14057C10.8632 6.14057 9.15329 6.95861 7.89753 8.24246L7.89754 -2.63656e-07L5.84229 -3.56821e-07L5.84229 8.24246C4.58654 6.95861 2.87658 6.14057 1.05358 6.14057L0.0259626 6.14057L0.0259625 8.24351L1.05358 8.24351C3.55995 8.24351 5.84229 10.5799 5.84229 13.1434L5.84229 14.1948L7.89753 14.1948L7.89753 13.1434Z" />
                                                        </svg>
                                                    </button>
                                                </h2>
                                                <div id="faqcollapseEight" className="accordion-collapse collapse" aria-labelledby="faqheadingEight" data-bs-parent="#accordionGeneral">
                                                    <div className="accordion-body">
                                                        Social media marketing can help your business by increasing brand awareness, driving website traffic, and fostering direct engagement with your target audience.
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="accordion-item mb-10">
                                                <h2 className="accordion-header" id="faqheadingNine">
                                                    <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqcollapseNine" aria-expanded="false" aria-controls="faqcollapseNine">
                                                        09. Do You Offer Training For In-House Marketing Teams?
                                                        <svg width={14} height={14} viewBox="0 0 14 14" xmlns="http://www.w3.org/2000/svg">
                                                            <path fillRule="evenodd" clipRule="evenodd" d="M7.89753 13.1434C7.89753 10.5799 10.1789 8.24351 12.6862 8.24351L13.7139 8.24351L13.7139 6.14057L12.6862 6.14057C10.8632 6.14057 9.15329 6.95861 7.89753 8.24246L7.89754 -2.63656e-07L5.84229 -3.56821e-07L5.84229 8.24246C4.58654 6.95861 2.87658 6.14057 1.05358 6.14057L0.0259626 6.14057L0.0259625 8.24351L1.05358 8.24351C3.55995 8.24351 5.84229 10.5799 5.84229 13.1434L5.84229 14.1948L7.89753 14.1948L7.89753 13.1434Z" />
                                                        </svg>
                                                    </button>
                                                </h2>
                                                <div id="faqcollapseNine" className="accordion-collapse collapse" aria-labelledby="faqheadingNine" data-bs-parent="#accordionGeneral">
                                                    <div className="accordion-body">
                                                        Yes, we offer customized training programs for in-house marketing teams. Our training sessions are tailored to meet your team's specific needs, covering key areas such as digital marketing strategies, content creation, SEO, social media management, and more.
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="accordion-item">
                                                <h2 className="accordion-header" id="faqheadingTen">
                                                    <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqcollapseTen" aria-expanded="false" aria-controls="faqcollapseTen">
                                                        10. How Do You Stay Up-To-Date With The Latest Marketing Trends?
                                                        <svg width={14} height={14} viewBox="0 0 14 14" xmlns="http://www.w3.org/2000/svg">
                                                            <path fillRule="evenodd" clipRule="evenodd" d="M7.89753 13.1434C7.89753 10.5799 10.1789 8.24351 12.6862 8.24351L13.7139 8.24351L13.7139 6.14057L12.6862 6.14057C10.8632 6.14057 9.15329 6.95861 7.89753 8.24246L7.89754 -2.63656e-07L5.84229 -3.56821e-07L5.84229 8.24246C4.58654 6.95861 2.87658 6.14057 1.05358 6.14057L0.0259626 6.14057L0.0259625 8.24351L1.05358 8.24351C3.55995 8.24351 5.84229 10.5799 5.84229 13.1434L5.84229 14.1948L7.89753 14.1948L7.89753 13.1434Z" />
                                                        </svg>
                                                    </button>
                                                </h2>
                                                <div id="faqcollapseTen" className="accordion-collapse collapse" aria-labelledby="faqheadingTen" data-bs-parent="#accordionGeneral">
                                                    <div className="accordion-body">
                                                        I stay up-to-date with the latest marketing trends by regularly reading industry blogs, following key influencers on social media, and participating in webinars and online courses.
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div className="tab-pane fade" id="strategy" role="tabpanel" aria-labelledby="strategy-tab" tabIndex={0}>
                                    <div className="faq-wrap">
                                        <div className="accordion" id="accordionGeneral">
                                            <div className="accordion-item mb-10">
                                                <h2 className="accordion-header" id="faqheadingOne">
                                ...
                                <div className="tab-pane fade" id="budget" role="tabpanel" aria-labelledby="budget-tab" tabIndex={0}>
                                    <div className="faq-wrap">
                                        <div className="accordion" id="accordionGeneral">
                                            <div className="accordion-item mb-10">
                                                <h2 className="accordion-header" id="faqheadingOne">
                                ...
                                <div className="tab-pane fade" id="traning" role="tabpanel" aria-labelledby="traning-tab" tabIndex={0}>
                                    <div className="faq-wrap">
                                        <div className="accordion" id="accordionGeneral">
                                            <div className="accordion-item mb-10">
                                                <h2 className="accordion-header" id="faqheadingOne">
