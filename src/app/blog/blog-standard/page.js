...
const BlogStandard = () => {
  ...
  const blogPosts = blogData.blog_grid
  return (
    <div>
      <Header1 style={"inner-page"} fluid='container' />
      <Breadcrum pageTitle={'Blog'} pagename={'Blog'} />
      <div className="blog-standard-page pt-150 mb-120" id="scroll-section">
            ...
            <div className="col-lg-8">
              ...
              {blogPosts.slice(0, 3).map((post) => (
                  <div className="col-md-12" key={post.id}>
                    <div className="blog-card2 blog-st magnetic-item">
                      <div className="blog-card-img-wrap">
                        <Link href={`/blog/blog-details/${slugify(post.blog_title)}`} className="card-img">
                          <img src={post.standard_image} alt={post.blog_title} />
                        </Link>
                      </div>
                      <div className="card-content">
                        ...
                        <h4><Link href={`/blog/blog-details/${slugify(post.blog_title)}`}>{post.blog_title}</Link></h4>
                        <Link href={`/blog/blog-details/${slugify(post.blog_title)}`} className="view-btn">
                ...
                <div className="single-widget mb-30">
                  ...
                  <div className="recent-post-widget mb-20">
                    <div className="recent-post-img">
                      <Link href="/bog/blog-details"><img src="/assets/img/inner-pages/popular-post-img1.png" alt="" /></Link>
                    </div>
                    <div className="recent-post-content">
                      <Link href="/blog">20 January, 2024</Link>
                      <h6><Link href="/bog/blog-details">Looking Inspiration Traveling The World.</Link></h6>
                    </div>
                  </div>
                  <div className="recent-post-widget mb-20">
                    <div className="recent-post-img">
                      <Link href="/bog/blog-details"><img src="/assets/img/inner-pages/popular-post-img2.png" alt="" /></Link>
                    </div>
                    <div className="recent-post-content">
                      <Link href="/blog">12 January, 2024</Link>
                      <h6><Link href="/bog/blog-details">Challenges creating a multi-brand system.</Link></h6>
                    </div>
                  </div>
                  <div className="recent-post-widget mb-20">
                    <div className="recent-post-img">
                      <Link href="/bog/blog-details"><img src="/assets/img/inner-pages/popular-post-img3.png" alt="" /></Link>
                    </div>
                    <div className="recent-post-content">
                      <Link href="/blog">04 January, 2024</Link>
                      <h6><Link href="/bog/blog-details">Decoding the Cloud And Deep Dive Creative.</Link></h6>
                    </div>
                  </div>
                </div>
                <div className="single-widget mb-30">
