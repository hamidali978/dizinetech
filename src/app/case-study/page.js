...
const CaseStudyPage = () => {
    const caseStudies = caseStudyData.case_study_card
    return (
        <>
            <Header1 style={"inner-page"} fluid="container" />
            <Breadcrum pageTitle={'Case Study'} pagename={'Case Study'} />
            <div className="case-study-page pt-150 mb-120" id="scroll-section">
                <div className="container">
                    <div className="row gy-5 mb-70">
                        {caseStudies.map((caseStudy) => (
                            <div className="col-lg-4 col-md-6" key={caseStudy.id}>
                                <div className="case-study-card3 two magnetic-item">
                                    <div className="case-study-content">
                                        ...
                                        <a href={`/case-study-details/${slugify(caseStudy.title)}`} className="view-btn two">
                                    ...
                                    <Link href={`/case-study-details/${slugify(caseStudy.title)}`} className="case-study-img">
                                        <img src={caseStudy.cover_image} alt={caseStudy.title} />
                                    </Link>
                                </div>
                            </div>
                        ))}
